...
Begin WebDialog WebDialog_Site_Edit
   ...
   Begin WebLabel Site_Name_Label
      ...
      _mPanelIndex    =   -1
   End
   Begin WebTextField Site_Name_TextField
   ...
   Begin WebButton Modify_Button
      ...
      _mPanelIndex    =   -1
   End
   Begin WebCheckbox Allcaps_Checkbox
      Caption         =   "All caps"
      ControlID       =   ""
      Enabled         =   True
      Height          =   34
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub ENABLE_Modify_Button()
		  ...
		  If Site_Name_TextField.Text.IsEmpty Then Return
		  ...
		  If rs.RowCount > 0 Then 
		    ...
		    Notes_Label.Text = "Site name exists in the data base!!!"
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  ...
			  Allcaps_Checkbox.Value = rs.column("is_uppercase").BooleanValue
			  Site_Name_TextField.Text = rs.Column("name").StringValue.Trim.Titlecase
...
#tag Events Site_Name_TextField
	#tag Event
		Sub TextChanged()
		...
		Sub Pressed()
		  ...
		  Try
		    ...
		    If db.Connect Then
		      ...
		      db.Prepare("UPDATE sites SET name = ?, is_uppercase = ? " _
		      +"WHERE " _
		      +"site_id = ?")
