...
Begin WebDialog WebDialog_Plan_Type_Add
   ...
   Begin WebLabel Plan_Type_Name_Label
      ...
      _mPanelIndex    =   -1
   End
   Begin WebTextField Plan_Type_Name_TextField
   ...
   Begin WebTextField Weight_TextField
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLabel No_Of_Plans_Label
      Bold            =   False
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
      ...
      _mPanelIndex    =   -1
   End
   Begin WebTextField No_Of_Plans_TextField
      AllowAutoComplete=   False
      AllowSpellChecking=   False
      Caption         =   ""
      ControlID       =   ""
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub ENABLE_Add_Button()
		  ...
		  If Plan_Type_Name_TextField.Text.IsEmpty Then Return
		  
		  If No_Of_Plans_TextField.Text.IsEmpty Then Return
		  If Not No_Of_Plans_TextField.Text.IsNumeric Then Return
...
#tag Events Plan_Type_Name_TextField
	#tag Event
		Sub TextChanged()
		  ENABLE_Add_Button
		End Sub
		...
		Sub Pressed()
		  ...
		  Try
		    ...
		    If db.Connect Then
		      ...
		      db.Prepare("INSERT INTO plan_types ( " _
		      + "name, weight, no_of_plans, site_id) " _
		      +"VALUES ( ?, ?, ?, ?)")
		      ...
		      Site_PopupMenu.RowTagAt( Site_PopupMenu.SelectedRowIndex) )
