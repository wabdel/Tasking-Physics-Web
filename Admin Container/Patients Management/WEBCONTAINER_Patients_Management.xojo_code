...
Begin WebContainer WEBCONTAINER_Patients_Management
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   Enabled         =   True
   ...
   _mDesignWidth   =   0
   _mPanelIndex    =   -1
   Begin WebTabPanel WebTabPanel_Patients_Management
      ControlCount    =   0
      ControlID       =   ""
      Enabled         =   True
      HasBorder       =   True
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub LOAD_TabPanel_Container(index as Integer)
		  Var left_position As Integer = WebTabPanel_Patients_Management.Left + 5
		  Var top_position As Integer = WebTabPanel_Patients_Management.top + 48
		  ...
		  Case 0
		    ...
		    Panel_Container = New WEBCONTAINER_Patients_Admin
...
#tag Events WebTabPanel_Patients_Management
	#tag Event
		Sub PanelChanged()
