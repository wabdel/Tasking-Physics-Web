...
Begin WebContainer WEBCONTAINER_Completed_Assigned_Tasks_Management1
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   Enabled         =   True
...
#tag Events Completed_Assigned_Tasks_ListBox
	#tag Event
		Sub Opening()
		  ...
		  Me.ReloadData
		  Completed_Assigned_Tasks_Label.Text = "Task = " + Me.DataSource.RowCount.ToString
	...
	#tag Event
		Sub Run()
		  If App.last_database_update <> Latest_UPDATE Then
		    ...
		    Completed_Assigned_Tasks_ListBox.ReloadData
		    Completed_Assigned_Tasks_Label.Text = "Task = " + Completed_Assigned_Tasks_ListBox.DataSource.RowCount.ToString
		    Latest_Update = App.last_database_update
