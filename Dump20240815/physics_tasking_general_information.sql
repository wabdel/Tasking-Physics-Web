...
CREATE TABLE `general_information` (
  `general_information_id` int NOT NULL AUTO_INCREMENT,
  `hospital_name` varchar(100) NOT NULL,
  `department_name` varchar(100) NOT NULL,
  `section_name` varchar(100) NOT NULL,
  `hospital_logo` blob,
  `random_seed` int unsigned NOT NULL DEFAULT '17327',
...
INSERT INTO `general_information` VALUES (1,'Hospital','Department','Department',NULL,1069139573);
