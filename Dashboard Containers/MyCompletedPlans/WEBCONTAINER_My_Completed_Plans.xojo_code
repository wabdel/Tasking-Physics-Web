...
Begin WebContainer WEBCONTAINER_My_Completed_Plans
   Compatibility   =   ""
   ControlID       =   ""
   Enabled         =   True
   Height          =   600
...
#tag Events My_Completed_Plans_ListBox
	#tag Event
		Sub Opening()
		  ...
		  Me.DataSource = New MyCompletedPlansDataSource
		  Me.ReloadData
		  My_Completed_Plans_Label.Text = "Plans = " + Me.DataSource.RowCount.ToString
