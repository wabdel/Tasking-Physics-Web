...
#tag Events My_Tasks_ListBox
	#tag Event
		Sub Opening()
		  ...
		  Me.DataSource = New MyAssignedTasksDataSource
		  Me.ReloadData
	...
	#tag Event
		Sub CustomCellAction(row as Integer, column as Integer, identifier as string, value as variant)
		  If identifier = "GroupButtonPressed" Then
		    ...
		    dialog.scheduled_task_id = Me.RowTagAt(row)
		    dialog.Show
		  ...
		  'My_Plans_Label.Text = "Plans = " + My_Tasks_ListBox.DataSource.RowCount.ToString
