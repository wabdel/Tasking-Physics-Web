...
Begin WebContainer WEBCONTAINER_Statistics_Plans_old
   ...
   Begin WebRadioGroup Period_RadioGroup
      ...
      _mPanelIndex    =   -1
   End
   Begin WEBCONTAINER_Replans_PieChart Replans_PieChart
      ControlCount    =   0
      ControlID       =   ""
      Enabled         =   True
      Height          =   500
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub POPULATE_Plans_Statistics_Plots()
		  Replans_PieChart.POPULATE_Replan_WebCHart(Date_DatePicker.SelectedDate, Period_RadioGroup.SelectedItem.Caption)
		End Sub
	#tag EndMethod
...
#tag Events Date_DatePicker
	...
	#tag Event
		Sub DateChanged(selectedDate As DateTime)
		  POPULATE_Plans_Statistics_Plots
		End Sub
	#tag EndEvent
#tag EndEvents
