...
Begin WebContainer WEBCONTAINER_Recent_Tasks
   Compatibility   =   ""
   ControlID       =   ""
   Enabled         =   True
   Height          =   600
   ...
   _mName          =   ""
   _mPanelIndex    =   -1
   Begin WebListBox Recent_Tasks_ListBox
      ColumnCount     =   1
      ColumnWidths    =   ""
      ControlID       =   ""
      Enabled         =   True
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLabel Recent_Tasks_Label
      Bold            =   False
      ControlID       =   ""
      Enabled         =   True
      FontName        =   ""
   ...
   Begin WebLabel Note_Label
      ...
      Scope           =   0
      TabIndex        =   2
      Text            =   "Tasks are listed for the past 0 days."
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   542
...
#tag Events Recent_Tasks_ListBox
	#tag Event
		Sub Opening()
		  Me.HasHeader = True
		  Me.RowSelectionType = WebListBox.RowSelectionTypes.None
		  Me.DataSource = New RecentTasksDataSource
		  Me.ReloadData
		  Recent_Tasks_Label.Text = "Tasks = " + Me.DataSource.RowCount.ToString
	...
	#tag Event
		Sub Run()
		  ...
		  If App.last_database_update <> Latest_UPDATE Then
		    ...
		    Recent_Tasks_ListBox.ReloadData
		    Recent_Tasks_Label.Text = "Tasks = " + Recent_Tasks_ListBox.DataSource.RowCount.ToString
		    Latest_UPDATE = App.last_database_update
