	...
	#tag Method, Flags = &h21
		Private Sub LOAD_TabPanel_Container(index as Integer)
		  ...
		  Case 0
		    ...
		    Panel_Container = New WEBCONTAINER_User_Statistics_Sites
		    
		  Case 1
		    
		    Panel_Container = New WEBCONTAINER_User_Statistics_Points
		    
		    
		  Case 2
		    
		    Panel_Container = New WEBCONTAINER_User_Statistics_Plans
		  ...
		  Panel_Container.EmbedWithin( User_Statistics_TabPanel, i, j, _
...
#tag Events User_Statistics_TabPanel
	#tag Event
		Sub PanelChanged()
