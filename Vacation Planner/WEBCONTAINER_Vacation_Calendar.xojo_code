...
Begin WebContainer WEBCONTAINER_Vacation_Calendar
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   Enabled         =   True
   ...
   Begin WebLabel Label_Date_Tiltle
      ...
      _mPanelIndex    =   -1
   End
   Begin WebContainer_Vacation_Date On_Call_Date_Container
      ControlCount    =   0
      ControlID       =   ""
      Enabled         =   True
      Height          =   120
   ...
   Begin WebContainer_Vacation_Date On_Call_Date_Container
      ...
      _mPanelIndex    =   -1
   End
   Begin WebButton Button_Manage_Vacations
      AllowAutoDisable=   False
      Cancel          =   False
      Caption         =   "Manage  vacations"
      ControlID       =   ""
      Default         =   True
      Enabled         =   True
      Height          =   38
...
#tag Events Label_Date_Tiltle
	...
	#tag EndEvent
#tag EndEvents
#tag Events Button_Manage_Vacations
	#tag Event
		Sub Pressed()
		  Var theDialog As New WebDialog_Manage_Vacations
		  theDialog.Show
		End Sub
	#tag EndEvent
	#tag Event
